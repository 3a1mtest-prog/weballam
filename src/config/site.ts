...
export const site = {
  ...
  description:
    "غزاوي ستور — متجرك الرقمي المتكامل لخدمات السوشيال ميديا، اليوزرات المميزة، الاشتراكات، بطاقات الشحن، باقات الاتصالات والخدمات الرقمية الاحترافية. جودة مضمونة ١٠٠٪ وتسليم فوري.",
