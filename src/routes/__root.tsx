...
function NotFoundComponent() {
  return (
    <div className="site flex min-h-dvh flex-col items-center justify-center gap-4 px-4 text-center">
      <h1 className="font-display text-6xl font-bold">404</h1>
      <p className="text-ink-dim">The page you're looking for doesn't exist or has been moved.</p>
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="site flex min-h-dvh items-center justify-center px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display text-3xl font-bold">This page didn't load</h1>
