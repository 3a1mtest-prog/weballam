...
export const metadata: Metadata = {
  title: "من نحن",
  description:
    "غزاوي ستور — قصتنا، قيمنا، وكيف بنشتغل. متجر رقمي متكامل بيخدم أكثر من 8 آلاف عميل بجودة مضمونة ودعم لا ينام.",
};
...
const values = [
  {
    ...
    body: "إذا الخدمة اللي طالبها مش رح تفيدك، بنحكيلك. سمعتنا أهم عندنا من أي طلب.",
  },
  {
    icon: Gem,
    title: "الجودة مش قابلة للتفاوض",
    body: "بنشتغل مع مزوّدين مختبرين فقط، وبنوقف أي خدمة بتنزل جودتها حتى لو كانت الأكثر مبيعاً.",
  },
  {
    icon: HeartHandshake,
  ...
  {
    icon: Compass,
    title: "نظام مش قطع متفرقة",
    body: "من الهوية للمحتوى للإعلان — بنبني حضورك كمنظومة واحدة متماسكة.",
  },
];
...
export default function AboutPage() {
  return (
    <>
      <PageHeader
        eyebrow="من نحن"
        title="غزاوي ستور — شريكك الرقمي"
        highlight="شريكك الرقمي"
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-12 lg:px-8">
          <Reveal className="lg:col-span-7">
            ...
            <div className="mt-6 space-y-5 text-[0.95rem] leading-loose text-fg-muted">
              <p>
                ليش صاحب المشروع الصغير لازم يدور على عشر جهات مختلفة عشان يبني
                حضوره الرقمي؟ واحد للمتابعين، واحد للتصميم، واحد للاشتراكات،
                وواحد للشحن — وكل واحد فيهم بيرد بعد يومين.
              </p>
              <p>
                من هون بدأ <strong className="text-offwhite">غزاوي ستور</strong>:
                مكان واحد بتلاقي فيه كل اللي بتحتاجه، بسعر واضح ومكتوب، ورد
                بيوصلك بدقائق مش بأيام.
              </p>
              <p>
                اليوم بنخدم أكثر من ٨ آلاف عميل بين أصحاب متاجر، منشئي محتوى،
                لاعبين وشركات — وكل واحد فيهم بيرجع لأنه لقي التعامل مريح
                والنتيجة صادقة.
              </p>
            </div>
