...
const steps = [
  ...
  },
  {
    n: "03",
    title: "شوف وادفع",
    body: "بنبعتلك صور اليوزر أو إحصائيات الحساب، وبتدفع بالطريقة اللي بتريحك مع تأكيد استلام فوري.",
  },
  {
    n: "04",
    title: "استلم واطمّن",
    body: "بننقل اليوزر أو نفعّل الباقة فوراً، وبنتابع معك لحد ما تتأكد إن كل إشي تمام.",
  },
];
